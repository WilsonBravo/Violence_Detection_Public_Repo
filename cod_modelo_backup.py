...
try:
    ...
    from variables import latitude, longitude, fps_cam, freq_send_message
...
def get_transfer_values(client_socket):
    ...
    while not stop_loop:
        try:        
            ...
            if mensaje.decode() == '\x01':
                ...
                # Datos a predecir
                data_eval, frames = get_transfer_values(client_socket)
